...
DETECTIONS = {"Ransom": ['3dm', '3ds', '3g2', '3gp', '602', 'arc', 'paq', 'accdb', 'aes', 'asc', 'asf', 'asm', 'asp', 'avi', 'backup', 'bak', 'bat', 'bmp', 'brd', 'bz2', 'cgm', 'class', 'cmd', 'cpp', 'crt', 'csr', 'csv', 'dbf', 'dch', 'der', 'dif', 'dip', 'djvu', 'doc', 'docb', 'docm', 'docx', 'dot', 'dotm', 'dotx', 'dwg', 'edb', 'eml', 'fla', 'flv', 'frm', 'gif', 'gpg', 'hwp', 'ibd', 'iso', 'jar', 'java', 'jpeg', 'jpg', 'jsp', 'key', 'lay', 'lay6', 'ldf', 'm3u', 'm4u', 'max', 'mdb', 'mdf', 'mid', 'mkv', 'mml', 'mov', 'mp3', 'mp4', 'mpeg', 'mpg', 'msg', 'myd', 'myi', 'nef', 'odb', 'odg', 'odp', 'ods', 'odt', 'onetoc2',
